...
<body>
  <div id="pagination" class="pagination">
    ...
    <c:url value="list?sheet=${questions.sheet}&tagType=${questions.name}&page=${questions.page}" var="prev">
    ...
    <c:forEach begin="1" end="${maxPages}" step="1" varStatus="i">
        <c:choose>
            ...
            <c:otherwise>
                <c:url value="list?sheet=${questions.sheet}&tagType=${questions.name}&page=${questions.page}" var="url">
    ...
    <c:url value="list?sheet=${questions.sheet}&tagType=${questions.name}&page=${questions.page}" var="next">
        <c:param name="page" value="${page + 1}"/>
    </c:url>
    <c:if  class="page-link" test="${page + 1 <= maxPages}">
