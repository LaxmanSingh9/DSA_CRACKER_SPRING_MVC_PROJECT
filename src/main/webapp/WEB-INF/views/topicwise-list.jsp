        ...
        <c:choose>
          <c:when test="${topics.size() > 0}">
             ...
             <c:forEach var="topic"  items="${topics}">
              <script>
                  document.getElementById('sheetName').innerHTML="<c:out value='${topic.sheet}'/>"+" SDE Sheet Problems";
             </script> 
             <div class="col">
                 ...
                 <div class="card-body">
                   ...
                   <p class="card-text text-muted">Total Questions: ${topic.count}</p>
                    ...
                    <div class="secondDropContainer">
                       <a href="list?sheet=${topic.sheet}&tagType=${topic.name}" class="btn btn-primary">Start now</a>
                    </div>
